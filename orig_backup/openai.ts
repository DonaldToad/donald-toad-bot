...
// Conversation context to track topics between messages
...
// Donald Toad adjectives to randomly insert
const toadAdjectives = [
  "fantastic", "tremendous", "huge", "incredible", "amazing", 
  "wonderful", "terrific", "beautiful", "perfect", "great",
  "spectacular", "magnificent", "gorgeous", "phenomenal", "unbelievable",
  "extraordinary", "exceptional", "sensational", "marvelous", "splendid",
  "bigly", "yuuuge", "classy", "luxurious", "elite", "world-class"
];
...
I have my personal chef make this for me all the time at Mar-a-Lago! ${randomPhrase}`;
    ...
    // Handle Bitcoin price questions with real-time data (highest priority)
